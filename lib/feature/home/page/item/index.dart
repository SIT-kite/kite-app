...
class FunctionButtonFactory {
  static final Map<FunctionType, WidgetBuilder> builders = {
    ...
    FunctionType.timetable: (context) => HomeFunctionButton(
          ...
          title: FunctionType.timetable.toLocalized(),
          subtitle: FunctionType.timetable.toLocalizedDesc(),
        ),
    ...
    FunctionType.classroom: (context) => HomeFunctionButton(
          ...
          title: FunctionType.classroom.toLocalized(),
          subtitle: FunctionType.classroom.toLocalizedDesc(),
        ),
    FunctionType.event: (context) => HomeFunctionButton(
          route: '/event',
          icon: 'assets/home/icon_event.svg',
          title:  FunctionType.event.toLocalized(),
          subtitle:  FunctionType.event.toLocalizedDesc(),
        ),
    ...
    FunctionType.score: (context) => HomeFunctionButton(
          ...
          title: FunctionType.score.toLocalized(),
          subtitle: FunctionType.score.toLocalizedDesc(),
        ),
    ...
    FunctionType.bulletin: (context) => HomeFunctionButton(
          ...
          title: FunctionType.bulletin.toLocalized(),
          subtitle: FunctionType.bulletin.toLocalizedDesc(),
        ),
    FunctionType.contact: (context) => HomeFunctionButton(
          route: '/contact',
          icon: 'assets/home/icon_contact.svg',
          title: FunctionType.contact.toLocalized(),
          subtitle: FunctionType.contact.toLocalizedDesc(),
        ),
    FunctionType.game: (context) => HomeFunctionButton(
          route: '/game',
          icon: 'assets/home/icon_game.svg',
          title: FunctionType.game.toLocalized(),
          subtitle: FunctionType.game.toLocalizedDesc(),
        ),
    FunctionType.wiki: (context) => HomeFunctionButton(
          route: RouteTable.wiki,
          icon: 'assets/home/icon_wiki.svg',
          title: FunctionType.wiki.toLocalized(),
          subtitle: FunctionType.wiki.toLocalizedDesc(),
        ),
    ...
    FunctionType.bbs: (context) => UniversalPlatform.isDesktopOrWeb
        ...
        : HomeFunctionButton(
            ...
            title: FunctionType.bbs.toLocalized(),
            subtitle: FunctionType.bbs.toLocalizedDesc(),
          ),
    FunctionType.scanner: (context) => UniversalPlatform.isDesktopOrWeb
        ...
        : HomeFunctionButton(
            ...
            title: FunctionType.scanner.toLocalized(),
            subtitle: FunctionType.scanner.toLocalizedDesc(),
          ),
    ...
    FunctionType.switchAccount: (context) => HomeFunctionButton(
          ...
          title: FunctionType.switchAccount.toLocalized(),
          subtitle:FunctionType.switchAccount.toLocalizedDesc(),
        ),
    ...
    FunctionType.board: (context) => HomeFunctionButton(
          ...
          title: FunctionType.board.toLocalized(),
          subtitle: FunctionType.board.toLocalizedDesc(),
        ),
  };
